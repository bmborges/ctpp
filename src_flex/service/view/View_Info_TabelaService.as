package service.view
{
	...
	public class View_Info_TabelaService{
		private var bridge:RemoteObject;
		private static var instance:View_Info_TabelaService;
		public static function getInstance():View_Info_TabelaService{
			if (instance == null){
				instance = new View_Info_TabelaService();
			}
			return instance;
		}
		...
		public function select(dados:View_Info_TabelaVO,result:Function,fault:Function,where:Array,order:Array):void{
		...
		public function View_Info_TabelaService()
		{
			bridge = new RemoteObject();
			bridge.showBusyCursor = true;
			bridge.destination = 'View_Info_TabelaService';
		}
	}
}