package service.view
{
	...
	public class View_Field_TabelaService{
		private var bridge:RemoteObject;
		private static var instance:View_Field_TabelaService;
		public static function getInstance():View_Field_TabelaService{
			if (instance == null){
				instance = new View_Field_TabelaService();
			}
			return instance;
		}
		...
		public function select(dados:View_Field_TabelaVO,result:Function,fault:Function,where:Array,order:Array):void{
		...
		public function View_Field_TabelaService()
		{
			bridge = new RemoteObject();
			bridge.showBusyCursor = true;
			bridge.destination = 'View_Field_TabelaService';
		}
	}
}