package service.view
{
	...
	public class View_Ctr_RestricaoService{
		private var bridge:RemoteObject;
		private static var instance:View_Ctr_RestricaoService;
		public static function getInstance():View_Ctr_RestricaoService{
			if (instance == null){
				instance = new View_Ctr_RestricaoService();
			}
			return instance;
		}
		...
		public function select(dados:View_Ctr_RestricaoVO,result:Function,fault:Function,where:Array,order:Array):void{
		...
		public function View_Ctr_RestricaoService()
		{
			bridge = new RemoteObject();
			bridge.showBusyCursor = true;
			bridge.destination = 'View_Ctr_RestricaoService';
		}
	}
}