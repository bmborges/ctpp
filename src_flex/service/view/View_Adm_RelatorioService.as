package service.view
{
	...
	public class View_Adm_RelatorioService{
		private var bridge:RemoteObject;
		private static var instance:View_Adm_RelatorioService;
		public static function getInstance():View_Adm_RelatorioService{
			if (instance == null){
				instance = new View_Adm_RelatorioService();
			}
			return instance;
		}
		...
		public function select(dados:View_Adm_RelatorioVO,result:Function,fault:Function,where:Array,order:Array):void{
		...
		public function View_Adm_RelatorioService()
		{
			bridge = new RemoteObject();
			bridge.showBusyCursor = true;
			bridge.destination = 'View_Adm_RelatorioService';
		}
	}
}